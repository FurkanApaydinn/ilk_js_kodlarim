...
// }
//-----------------------------------Nesneler Değere Göre Değil Referansa Göre İletilir---------------------
let nesne={color:"yeşil"};
let sayı=1;
let dize="inek";
console.log(`önce:${sayı} ${nesne.color}${dize}`)
function değer(nesne,dize,sayı){
  nesne.color="mavi";
  sayı =5
  dize="at"
  console.log(`içeride: ${sayı} ${nesne.color} ${dize}`)
}
değer(nesne,sayı,dize)
console.log(`Sonra: ${sayı} ${nesne.color} ${dize}`);
